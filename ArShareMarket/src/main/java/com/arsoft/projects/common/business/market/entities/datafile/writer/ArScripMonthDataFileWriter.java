...
public class ArScripMonthDataFileWriter implements ArScripDataFileWriter_IF {
	...
	public void updateData(ArScripDataFile arScripDataFileCached, ArScripDataFile arScripDataFileNew) throws ArException{
		...
		ArScripMonthDataFileFooter footerCached = (ArScripMonthDataFileFooter) arScripDataFileCached.getArScripDataFileFooter();
	...
	public static ArScripDataFileWriter_IF getArScripDataWriter() {
		return new ArScripMonthDataFileWriter();
	}
