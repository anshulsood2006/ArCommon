 ...
 * 
 */
@WebServiceClient(name = "HelloWorldServiceImplService", targetNamespace = "http://server.soap.learning.artutorial.projects.arsoft.com/", wsdlLocation = "http://localhost:8888/ws/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWORLDSERVICEIMPLSERVICE_QNAME = new QName("http://server.soap.learning.artutorial.projects.arsoft.com/", "HelloWorldServiceImplService");
    ...
    public HelloWorldService getHelloWorldServiceImplPort() {
        return super.getPort(new QName("http://server.soap.learning.artutorial.projects.arsoft.com/", "HelloWorldServiceImplPort"), HelloWorldService.class);
    }
    ...
    public HelloWorldService getHelloWorldServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server.soap.learning.artutorial.projects.arsoft.com/", "HelloWorldServiceImplPort"), HelloWorldService.class, features);
    }
