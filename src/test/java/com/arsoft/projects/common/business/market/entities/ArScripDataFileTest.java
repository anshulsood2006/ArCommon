...
public class ArScripDataFileTest {
	...
	public void verifyGetScripDataFileName() throws ParseException{
		...
		String fileName = ArScripDataFileHeader.getScripDataFileName(arScrip, ArScripDataFileEnum.CURRENT_DATA_FILE);
		assertEquals(fileName, "HCL_Current_Data_05_07_2018");
		fileName = ArScripDataFileHeader.getScripDataFileName(arScrip, ArScripDataFileEnum.DAY_DATA_FILE);
		assertEquals(fileName, "HCL_Day_Data_05_07_2018");
		fileName = ArScripDataFileHeader.getScripDataFileName(arScrip, ArScripDataFileEnum.COMPLETE_DAY_DATE_FILE);
		assertEquals(fileName, "HCL_Complete_Day_Data_05_07_2018");
		fileName = ArScripDataFileHeader.getScripDataFileName(arScrip, ArScripDataFileEnum.MONTH_DATA_FILE);
		assertEquals(fileName, "HCL_Month_Data_07_2018");
		fileName = ArScripDataFileHeader.getScripDataFileName(arScrip, ArScripDataFileEnum.WEEK_DATA_FILE);
		assertEquals(fileName, "HCL_Week_Data_27_2018");
		fileName = ArScripDataFileHeader.getScripDataFileName(arScrip, ArScripDataFileEnum.YEAR_DATA_FILE);
