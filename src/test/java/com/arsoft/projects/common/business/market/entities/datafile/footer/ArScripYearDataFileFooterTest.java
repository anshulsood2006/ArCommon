...
public class ArScripYearDataFileFooterTest {
	...
	public void verify() throws ArException {
		...
		ArScripYearDataFileFooter footer = (ArScripYearDataFileFooter) ArScripYearDataFileFooter.getArScripDataFileFooter(footerString, arScrip);
