			...
			<div class="content">	
				<form data-ng-app="myApp" data-ng-controller="dukaanIndexController" name="myForm" novalidate>
					...
					<tr><td><b>Name:</b></td><td>
						<input type="text" name="user" data-ng-model="user" required size="51">
					...
					<tr><td><b>Email:</b></td><td>
						<input type="email" name="email" data-ng-model="email" required size="51">
					...
					<tr><td><b>Phone:</b></td><td>
						<input type="text" name="phone" data-ng-model="phone" required onkeypress='return event.charCode >= 48 && event.charCode <= 57' maxlength="10" size="51">
					...
					<tr>
						<td colspan="2" align="center"><button style="color:green;" data-ng-disabled="myForm.user.$invalid || myForm.email.$invalid || myForm.phone.$invalid || myForm.address.$invalid || myForm.order.$invalid || buttonPress" data-ng-click="sendMail()"><b>Place Your Order</b></button></td>
					</tr>
