...
public class ArScripFileDataFooterFactory {
	...
	public static ArScripDataFileFooter getArScripFileDataFooterAsString(String scrip, ArScripDataFileEnum arScripDataFileEnum, ArScripDataFileFooter arScripFileDataFooter) {
		return null;
	}
